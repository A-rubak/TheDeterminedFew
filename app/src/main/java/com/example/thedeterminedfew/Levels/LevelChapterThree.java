...
public class LevelChapterThree extends Level {
    ...
    public LevelChapterThree(Context context, PointF mScreenSize, GameEngine ge){
        super();
    ...
    ArrayList<GameObject> buildGameObjects(GameObjectFactory factory){
        ...
        objects.add(factory.create(new CharacterSpecJewel(CharacterSpots.FIRST)));
        objects.add(factory.create(new CharacterSpecCinder(CharacterSpots.SECOND)));
        objects.add(factory.create(new CharacterSpecMain(CharacterSpots.THIRD)));
        ...
        objects.add(factory.create(new EnemySpecGuard(CharacterSpots.THIRD)));
