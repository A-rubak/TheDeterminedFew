...
import com.example.thedeterminedfew.ObjectSpecifications.*;


import java.util.ArrayList;

public class LevelChapterOne extends Level {
    ...
    public LevelChapterOne(Context context, PointF mScreenSize, GameEngine ge){
        super();
    ...
    ArrayList<GameObject> buildGameObjects(GameObjectFactory factory){
        ...
        objects.add(factory.create(new CharacterSpecMain(CharacterSpots.FIRST)));
